angular.module('ui.bootstrap.popover', []).directive('popover', 
...
.directive('popTarget', ['$rootScope', '$interpolate', function($rootScope, $interpolate) {
  return {
    restrict: 'CA',
    link: function(scope, elm, attrs) {
      var idAttr = $interpolate(attrs.popTarget);
